...
const WORKER_VERSION = "2026-08-02-live-scenes-v23-d4e5f6a";
...
const startFrameCapture = (page, dir, intervalMs = SCENE_FRAME_INTERVAL_MS) => {
  ...
  const run = (async () => {
    ...
    while (!stopped) {
      ...
      try {
        await page.screenshot({ path: framePath, type: "jpeg", quality: 80, fullPage: false, timeout: 4000, animations: "allow" });
